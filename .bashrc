...
__conda_setup="$('/home/nicklas/mambaforge/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/nicklas/mambaforge/etc/profile.d/conda.sh" ]; then
        . "/home/nicklas/mambaforge/etc/profile.d/conda.sh"
    else
        export PATH="/home/nicklas/mambaforge/bin:$PATH"
    fi
fi
unset __conda_setup

if [ -f "/home/nicklas/mambaforge/etc/profile.d/mamba.sh" ]; then
    . "/home/nicklas/mambaforge/etc/profile.d/mamba.sh"
fi
# <<< conda initialize <<<
