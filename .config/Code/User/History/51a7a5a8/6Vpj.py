        ...
        with Pool(processes=5) as pool:
            ...
            for epoch in tqdm(range(1, args.epochs_adj + 1), leave=False, desc="Epochs", position=0):
                ...
                for data in tqdm(loader, leave=False, desc="Batches", position=1):
                    ...
                    total_time_saveing_bert += pc() - time_saveing_bert
                ...
                with torch.no_grad():
                    ...
                    wandb.log({"time":
                        {"total_time_bert": total_time_bert,
                         "total_time_saveing_bert": total_time_saveing_bert,
                         "total_time_load_bert": total_time_load_bert,
                         "total_time_mlp": total_time_mlp,
                         "step": epoch,
                         }}, commit=False)
