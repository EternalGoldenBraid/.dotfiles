...
def cut_audio(input='download.wav', output='audio.wav', start=0, end=0):
    """
    Let's cut the first 20 minutes of the audio

    Args:
        input (str, optional): Input file. Defaults to 'download.wav'.
        output (str, optional): Output file. Defaults to 'audio.wav'.
