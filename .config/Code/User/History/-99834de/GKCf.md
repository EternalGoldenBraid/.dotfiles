...
Alternatively use a segmentator of choice that provides binary mask as in 
`utility\load_segmentation_model_chroma.py`. OVE6D assumes binary segmentation mask.
