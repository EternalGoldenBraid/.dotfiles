...
def load_vaaliperttu_data(config: DictConfig, tokenizer=None):
    ...
    train_mask = sample_mask(split_idx['train'], ds.n_participants)
    val_mask = sample_mask(split_idx['val'], ds.n_participants)
    test_mask = sample_mask(split_idx['test'], ds.n_participants)
