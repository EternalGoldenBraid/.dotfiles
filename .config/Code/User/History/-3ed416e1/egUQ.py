...
ribosome_all_positions[0, 0] = ribosome1_position
ribosome_all_positions[0, 1] = ribosome2_position

from test_vis import RiboVisualizer
vis = RiboVisualizer(None, initial_positions=ribosome_all_positions[0])
...
for x in range(translation_time):   # milliseconds. Variable defined above
    ...
    vis.update(ribosome_all_positions[x])
...
# for t in range(ribosome_all_positions[1:].shape[0]):
    # vis.update(ribosome_all_positions[t])
    # plt.pause(0.5)
