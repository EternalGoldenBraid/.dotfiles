...
ribosome_all_positions = np.array((2, translation_time), dtype = int)
...
# Create animation
ani = FuncAnimation(fig, update_plot, frames=range(-1, total_time_steps), fargs=(ax, ribosome_all_positions.T), interval=1000, repeat=False)
