...
for x in range(translation_time):   # milliseconds. Variable defined above
    ...
    Arguments:
    circRNA_length: length of the circRNA in codons
    ribosome_length: length of the ribosome in codons
    ribosome1_position: position of ribosome 1 on the circRNA
    ribosome2_position: position of ribosome 2 on the circRNA
    ribosome1_stepsmade: number of steps made by ribosome 1
    ribosome2_stepsmade: number of steps made by ribosome 2
    ribosome1_stallcounter: number of times ribosome 1 has been bumped
    ribosome2_stallcounter: number of times ribosome 2 has been bumped
    ribosome1_liststepdurations: list of step durations of ribosome 1
    """
