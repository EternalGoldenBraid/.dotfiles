...
def animate_projection(vis, mesh=mesh, K=K, initial_coords=initial_coords, t=0):
    
    # Move the mesh closer to the plane
    # mesh.translate((0, 0, -1), relative=True)
    mesh.translate((0, 0, height_at_time(t)), relative=True)
    t = t + 1/n_steps_max
    ...
    # mesh.vertices = o3d.utility.Vector3dVector( verts/(t*initial_coords[...]))
