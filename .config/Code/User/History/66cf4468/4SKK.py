...
class Experiment:
    ...
    def train_end_to_end_mlp(self, config):
        ...
        model_save_path = Path(config.outputs_dir, config.model.slaps_save_dir, "best_model__mlp_clf.pt")
        model_save_path.parent.mkdir(parents=True, exist_ok=True)

        args = config.model.mlp
    ...
    def train_end_to_end(self, config):
        ...
        model_save_path = Path(config.outputs_dir, config.model.slaps_save_dir, "best_model_clf.pt")
        model_save_path.parent.mkdir(parents=True, exist_ok=True)
        ...
        if config.model.save_adjacency and best_Adj is not None:
            save_dir = Path(config.outputs_dir, config.model.slaps_save_dir)
