...
from geom_utils import (generate_rotation_matrices,)
...
while True:
    ...
    pcl1.rotate(rotations[rot_idx % num_rotations], center=[0,0,0])
    rot_idx += 1
    ...
    tick_return = viewer.run_one_tick()
                                         
    print("Hep")
                                         
    if tick_return == False:
        print("Done")
        break
