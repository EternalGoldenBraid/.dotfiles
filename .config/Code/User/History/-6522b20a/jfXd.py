...
class Experiment:
    ...
    def train_end_to_end_mlp(self, config):
        ...
        train_dataloader = torch.utils.data.DataLoader(dataset, batch_size=config.bert.batch_size,
                                                        shuffle=False, sampler=train_sampler)
        val_dataloader = torch.utils.data.DataLoader(dataset, batch_size=config.bert.batch_size,
                                                        shuffle=False, sampler=val_sampler)
        test_dataloader = torch.utils.data.DataLoader(dataset, batch_size=config.bert.batch_size,
