...
class Experiment:
    ...
    def train_end_to_end_mlp(self, config):
        ...
        train_dataloader = DataLoader(dataset, batch_size=2, shuffle=False, sampler=train_sampler)
        val_dataloader = DataLoader(dataset, batch_size=2, shuffle=False, sampler=val_sampler)
        test_dataloader = DataLoader(dataset, batch_size=2, shuffle=False, sampler=test_sampler)
