...
class Experiment:
    ...
    def train_end_to_end_mlp(self, config):
        ...
        # Create samplers without indices argument
        train_sampler = ConcatenateThenShuffleSampler(train_dataset)
        val_sampler = ConcatenateThenShuffleSampler(val_dataset)
        test_sampler = ConcatenateThenShuffleSampler(test_dataset)
