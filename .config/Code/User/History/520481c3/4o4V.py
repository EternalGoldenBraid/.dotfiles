...
def visualize_dataset(df: pd.DataFrame, dataset: EventFeatureDataset, cfg: DictConfig):
    ...
    fig_labels.savefig(Path(cfg.paths.outputs_dir,cfg.paths.vis_dir)/"labels.png")
    ...
    fig_wordcloud.savefig(Path(cfg.paths.outputs_dir,"visualizations","wordcloud.png"))