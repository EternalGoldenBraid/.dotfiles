...
class MLMVaaliKoneDataset(Dataset):
    ...
    def __getitem__(self, index) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        input_ids = self.tokenizer.encode(question, comment, add_special_tokens=True, return_tensors='pt').squeeze()
        input_ids = self.tokenizer.encode(comment, add_special_tokens=True, return_tensors='pt').squeeze()
