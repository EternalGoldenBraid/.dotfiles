...
class VaalikoneClassifier(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        warmup_steps = math.ceil(len(self.train_dataloader()) * self.config["epochs"] * self.config["warmup_proportion"])
        total_steps = math.ceil(len(self.train_dataloader()) * self.config["epochs"])
