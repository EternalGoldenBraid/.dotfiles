...
def animate_projection(vis, t=0, K=K, mesh=mesh):
    ...
    # import pdb; pdb.set_trace()
    mesh_pcl_ = vis.get_geometry('object')
    # vis.update_geometry('object', mesh_pcl_, O3DVisualizer.TickResult.REDRAW) # Only supported to t.PointCloud
    vis.update_geometry('object', mesh_pcl_, 1) # Only supported to t.PointCloud
    # vis.show_geometry('object', mesh_pcl_, O3DVisualizer.TickResult.REDRAW)
