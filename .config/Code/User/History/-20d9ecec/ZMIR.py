...
def animate_projection(vis, t=0, K=K, mesh=mesh):
    ...
    # import pdb; pdb.set_trace()
    # vis.update_geometry('object', mesh_pcl_, O3DVisualizer.TickResult.REDRAW) # Only supported to t.PointCloud
    vis.scene.scene.update_geometry('object', mesh_pcl, 0) # Only supported to t.PointCloud
    print(type(vis.scene.scene))
    # vis.show_geometry('object', mesh_pcl, O3DVisualizer.TickResult.REDRAW)
    vis.add_geometry('object', mesh_pcl)
