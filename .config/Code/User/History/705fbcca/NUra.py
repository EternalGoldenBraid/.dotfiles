...
class CircleRNA:
    ...
    def interact_with(self, other_circle, strength=0.001, action='attract', max_dist=10*self.radius):
        ...
        if np.linalg.norm(self.center - other_circle.center) <= 2*self.radius or np.linalg.norm(self.center - other_circle.center) > max_dist:
            return
