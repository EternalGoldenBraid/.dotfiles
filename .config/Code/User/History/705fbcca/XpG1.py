...
class Ribosome:
    ...
    def interact_with(self, other_ribosome, 
        ...
        circle_distance_norm = np.clip(1-np.linalg.norm(self.circle.center - other_ribosome.circle.center), 0., 0.2)
        print(circle_distance_norm)
        # print(volume)
