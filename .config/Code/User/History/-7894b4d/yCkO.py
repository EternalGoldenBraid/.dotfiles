...
def aggregate_statistics(participant_features: torch.tensor, features: torch.tensor,
                         participant_idxs: torch.tensor, participant_idx_to_id: torch.tensor) -> torch.tensor:
    ...
    for i in range(participant_idx_to_id):
        participant_id = participant_idx_to_id[i]
        participant_mask = participant_idxs == participant_id
