...
def animate_projection(vis, t=0, K=K, mesh=mesh):
    ...
    vis.remove_geometry(name='object')
    vis.update_geometry(name='object', model=mesh, material=None, time=t, 1) # Only supported to t.PointCloud
    # vis.scene.scene.update_geometry('object', mesh, 0)
    # vis.update_geometry('object', mesh, 0)
    # time.sleep(.1)
