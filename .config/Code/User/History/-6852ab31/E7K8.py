...
class VaalikoneDataset(Dataset):
    ...
    def create_users_data(self):
        ...
        def concat_tensors(group):
            ...
            for idx in tqdm(group.index, desc="Concatenating tensors", leave=False):
        ...
        users_data = {participant_id: concat_tensors(group) for participant_id, group in grouped_data}
